...
const songs = [
  {
    ...
    source: "Sundo.mp3",
    description: "I chose this because kahit hindi ako laging sad, the song fits that chill, “okay lang mag-senti kahit walang reason” vibe. The music sounds gentle pero emotional, parang may naghahanap sa’yo, tapos finally, you’re found. It’s usually my go-to kapag gusto q vibe at night.",
  },
  {
    title: "Cry",
    name: "Cigarettes After Sex / Dream Pop · Ambient",
    source: "Cry.mp3",
    description: "This song is my mood whenever gusto kong malungkot — may ganun talaga na phases kahit anong mood mo. Chill tempo and soft vocals na parang lullaby pero may sadness na beautiful din. I chose this one kasi top tier CAS, perfect kapag gusto mo mag-reflect deeply.",
  },
  {
    title: "Dreaming",
  ...
  },
  {
    ...
    description: "Second all-time fave ko 'to sha. Parang pag iniwan ako ng partner q, expect na naka auto replay 'to sa isip ko. Raw and honest yung lyrics, tapos Gracie’s soft voice makes the pain real pero comforting din. Pinili ko 'to sha kasi perfect sa love, regret, and vulnerability na feeling to the point na f na f talaga.",
  },
  {
